...
setwd("C:/Trabajo BCRP/Scripts/GLP Granel/Data")
data<- read_excel("dfGLGranel_Lima17-05.xlsx")
...
prices<-text_matrix(prices, table_title='Precios Promedio de venta en Lima por Distrito del GLP-Granel en Gasocentros-17/05/2022 (Galones)')

write.table(prices, 'ConsolidadoGLP-Granel-17-05.csv', row.names=F, col.names=F, sep=',')
